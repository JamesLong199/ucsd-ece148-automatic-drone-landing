...
def localize_camera(fname,cam_matrix,dist_coeffs,tag_list):
    ...
    end_time = time.time()
    print('used %3f s' % (end_time - start_time))
...
# code for running apriltag localization experiment
if __name__ == '__main__':

    with open('new_drone_cam_params.pickle', 'rb') as f:
        cam_matrix,dist_coeffs = pickle.load(f)

    fname = 'new_images/2021_06_06_18_26_50.jpg'
    # fname = 'apriltag_images/a_1.jpg'

    myTagList = TagList(tag_size=0.084)
    myTagList.add_tag(family='tagStandard41h12', id=2, pos=(0, 0, 0),
